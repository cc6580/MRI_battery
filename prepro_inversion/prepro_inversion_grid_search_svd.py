# -*- coding: utf-8 -*-
"""prepro_inversion grid search_SVD.py

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_yW7IEqdjQu1a-FApKw7Ku7cVnSQP7Uu
"""
...
for i in np.arange(test_data.shape[0]):
  ...
  newz = test_data[i,:,:,1]*1e-7
    # since field values were scaled by 1e10, SVD's calculated suscept is also scaled by 1e10
    # but the generated true suscept is actually just scaled by 1e3
    # so, we need to scale SVD's calculation back down by 1e-7 in order to fairly compare the values
